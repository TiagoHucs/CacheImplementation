...
public class NamesService {
    ...
    private List<String> nomes = Arrays.asList("Benjamin Mateus Lucca Ribeiro","Felipe Enrico Leonardo Peixoto","Allana Giovana Farias","Isabelly Laís Renata Monteiro","Analu Cecília Patrícia Caldeira","Malu Allana da Cunha","Regina Alice Ferreira","Lucca Daniel Marcos Vinicius dos Santos",
